...
import 'package:carbonless_business/providers/controllers/loaders/view_loading_controller_provider.dart';
import 'package:carbonless_business/providers/states/qr_generator_state.dart';
import 'package:carbonless_business/services/http_utils/request_provider.dart';
...
class QrGeneratorController extends StateNotifier<QrGeneratorState> {
  ...
  void initialize() async {
    ...
    http.Response response = await ref.read(httpServiceProvider).executeHttp(
        RequestType.GET, null, null, Endpoint.GENERATE_QR_CODE, null);
